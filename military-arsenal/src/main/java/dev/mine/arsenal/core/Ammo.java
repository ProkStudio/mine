...
public enum Ammo {
    ...
    HEAVY("heavy_round", "Heavy pistol rounds", "Тяжёлые патроны", 7, 1, 0, 0, 0, false, false),
    ...
    GRENADE_HE("grenade_he", "HE launcher rounds", "Гранаты для Arc: HE", 12, 1, 0, 1.1, 4, false, false),
    GRENADE_SMOKE("grenade_smoke", "Smoke launcher rounds", "Гранаты для Arc: дым", 0, 1, 0, 1, 0, false, true),
    ...
    HAND_HE("frag_grenade", "Hand grenade (HE)", "Ручная граната (HE)", 10, 1, 0, .85, 4, false, false),
    HAND_SMOKE("smoke_grenade", "Hand grenade (smoke)", "Ручная дымовая граната", 0, 1, 0, .85, 0, false, true);
    ...
    public boolean handGrenade() { return this==HAND_HE || this==HAND_SMOKE; }
    public boolean grenade() { return this==GRENADE_HE || this==GRENADE_SMOKE || handGrenade(); }

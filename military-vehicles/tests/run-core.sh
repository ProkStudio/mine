...
javac --release 21 -d build/core-smoke src/main/java/com/prokstudio/militaryvehicles/core/{TruckSpec,VehicleKind,ControlLatch,TruckPhysics,TruckGeometry,VehicleGeometry,VehicleSave}.java src/test/java/com/prokstudio/militaryvehicles/CoreSmoke.java

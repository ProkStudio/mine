...
public final class GenerateRecipes {
    ...
    public static void generate(Path resources) throws Exception {
        ...
        Map<VehicleKind,String> modules=Map.of(VehicleKind.TRUCK,"minecraft:chest",VehicleKind.BUGGY,"minecraft:rabbit_hide",VehicleKind.CARRIER,"minecraft:iron_block",VehicleKind.TANK,"minecraft:obsidian",VehicleKind.TANKER,"minecraft:cauldron",VehicleKind.WORKSHOP,"minecraft:anvil",VehicleKind.RECOVERY,"minecraft:piston",VehicleKind.HOWITZER,"minecraft:dispenser",VehicleKind.IFV,"minecraft:crossbow");

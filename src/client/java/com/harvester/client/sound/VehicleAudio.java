...
public final class VehicleAudio {
    ...
    private static void configure() {
        ...
        try {
            ...
            float value=Float.parseFloat(p.getProperty("engineVolume","0.65")); gain=Float.isFinite(value)?Math.clamp(value,0,1):.65f;
    ...
    public static void tick(MinecraftClient client) {
        ...
        clock++; var manager=client.getSoundManager();

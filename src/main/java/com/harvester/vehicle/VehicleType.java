...
public enum VehicleType {
    COMBINE("combine_spawn_egg", Family.COMBINE, "Комбайн", .15, 1600, 100, 27, 1, 1, 3.8f, 3.1f),
    COMBINE_WIDE("combine_wide", Family.COMBINE, "Комбайн широкий", .12, 2400, 140, 54, 2, 1, 4.8f, 3.1f),
    DOZER("bulldozer", Family.DOZER, "Бульдозер", .13, 2000, 160, 27, 1, 1, 3f, 2.7f),
    DOZER_HEAVY("bulldozer_heavy", Family.DOZER, "Бульдозер тяжёлый", .10, 3000, 220, 54, 2, 1, 4f, 2.8f),
    PICKUP("pickup", Family.PICKUP, "Пикап", .32, 1800, 100, 27, 0, 1, 2f, 2.2f),
    PICKUP_CARGO("pickup_cargo", Family.PICKUP, "Пикап грузовой", .28, 2400, 130, 54, 0, 1, 2.2f, 2.2f),
    MOTORCYCLE("motorcycle", Family.MOTORCYCLE, "Мотоцикл", .38, 1000, 70, 9, 0, 2, .9f, 1.5f),
    MOTORCYCLE_TOURING("motorcycle_touring", Family.MOTORCYCLE, "Мотоцикл туристический", .36, 1600, 90, 18, 0, 2, 1f, 1.6f),
    ...
    PLANE("plane", Family.PLANE, "Самолёт", .42, 2400, 120, 18, 0, 1, 3.2f, 2.2f),
    PLANE_CARGO("plane_cargo", Family.PLANE, "Самолёт грузовой", .38, 3200, 160, 36, 0, 1, 4f, 2.2f),
    HELICOPTER("helicopter", Family.HELICOPTER, "Вертолёт", .30, 2400, 120, 18, 0, 1, 2.6f, 2.6f),
